package com.bridge.address_book;
		...
		while (label) {
			...
			case 1:
				...
				while (numOfContacts > 0) {
					...
					contactInfo();
					// Contact person4 = new
					// Contact(firstName,lastName,address,state,zip,phoneNumber,email);
					personDetails[counterForAdd++] = new Contact(firstName, lastName, address, state, zip, phoneNumber,
							email);
					numOfContacts--;
					numOfPerson++;
				}
